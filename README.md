...
* **For Modders (Open Source):** The raw code framework in this repository is licensed under the **MIT License**. You can modify it to build your own distinct projects or mods.
* **For Storefronts (Proprietary):** The actual game—including its specific combination of mechanics, level designs, artwork, music, and the title—is owned exclusively by **eons2eons** under an **All Rights Reserved** license. 
* **The Rule:** You can use this code to learn or build a new game, but you cannot copy this game's exact design, clone its identical gameplay layout, or use its branding to sell a look-alike on **Steam** or **Itch.io**. Commercial spin-offs must be technically and visually unique games.
